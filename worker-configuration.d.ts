/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cc5a2860e537a15feee173d9217b0dce)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "ConversionContainer";
	}
	interface Env {
		...
		CONVERSION_CONTAINER: DurableObjectNamespace<import("./src/worker/index").ConversionContainer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENABLE_AI" | "ENABLE_CONVERSIONS">> {}
}
